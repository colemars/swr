import React, { useRef, useMemo, useCallback, useDebugValue, useState } from 'react';
import { useSyncExternalStore } from 'use-sync-external-store/shim/index.js';
import { OBJECT, SWRConfig, defaultConfig, withArgs, SWRGlobalState, serialize, createCacheHelper, isUndefined, UNDEFINED, isPromiseLike, getTimestamp, isFunction, revalidateEvents, internalMutate, useIsomorphicLayoutEffect, subscribeCallback, IS_SERVER, rAF, IS_REACT_LEGACY, mergeObjects, withMiddleware, useSWRConfig } from 'swr/_internal';
...
const useSWRHandler = (_key, fetcher, config)=>{
    ...
    let fallback = isUndefined(fallbackData) ? isUndefined(config.fallback) ? UNDEFINED : config.fallback[key] : fallbackData;
